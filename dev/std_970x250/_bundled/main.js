...
function start_horizontal(_ref) {
	var tl_text = _ref.tl_text;
	var listB = _ref.listB;
	var text_x = _ref.text_x;
	...
	tl.add((0, _commonJsCommonJs.sentence)(listB), "+=.3");

	if (_commonJsCommonJs.size.w === 320 && _commonJsCommonJs.size.h === 50) {} else {
		tl.from('.cta_wager', .1, { opacity: 0 }, "+=.5");
		tl.to('.cta_wager', .1, { opacity: 0 }, "+=2.3");
		tl.from('.cta_odds', .2, { opacity: 0 }, "+=.3");
	}
